...
import {
  ...
  HeartIcon, DropletIcon, SettingsIcon, BellIcon,
} from 'lucide-react';
...
export function Navbar() {
  ...
  const handleCloseNotifications = () => {
    ...
    if (token && currentUser && currentUser.role !== 'admin') {
      fetch(`${API}/api/notifications/unread-count`, {
        ...
        .catch(err => console.error('[Navbar] Failed to refresh unread count:', err));
    }
  };
  ...
  return (
    <>
      ...
      {/* NotificationPanel rendered via portal — completely outside the header's stacking context */}
      {createPortal(
        <NotificationPanel
